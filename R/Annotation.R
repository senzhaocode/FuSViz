...
#'
#' @param ensemblId A string of ensembl gene id (e.g. \emph{ENSG00000141510}).
#' @param txdb_ref An object - an annotation database engine that was imported from *.sqlite file (initially created by compiling a GTF annotation file).
#' @param grTrack_ref An object contains annotation tracks, which was loaded from *.Rd file (originally generated by processing \code{txdb_ref} object).
#'
...
#'
#' @param ensemblId A string of ensembl gene id (e.g. \emph{ENSG00000141510}).
#' @param txdb_ref An object - annotation database engine that was imported from *.sqlite file (initially created by compiling a GTF annotation file).
#' @param grTrack_ref An object contains annotation tracks, which was loaded from *.Rd file (originally generated by processing \code{txdb_ref} object).
