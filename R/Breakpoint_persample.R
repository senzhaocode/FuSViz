...
#' @param object A list collects geneA / geneB breakpoint annotation, two key elements (i.e. a GRange object: \code{object\$txTr_f} and a data.frame object: \code{object\$dataset}).
#' @param whole_tx A GRange object - exon interval grouped by transcript per gene, which is generated by processing \code{txdb_ref} object.
