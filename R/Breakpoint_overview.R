...
#'
#' @return A list has two data.frame elements (i.e. \code{transcript} and \code{select_region}) with transcript and breakpoint annotations of partner genes
#'
#' @export
gene_trans_ex_overview <- function(breakpoint, object, whole_tx, offset=2000) {
