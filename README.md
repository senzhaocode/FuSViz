...
6. If users have a problem to install the dependency R package [**stringi**](https://github.com/gagolews/stringi) (the latest release) for **CentOS or RHEL** before FuSViz setup, 
