...
6. If users have a problem to install R package [**stringi**](https://github.com/gagolews/stringi) (the latest release) for **CentOS or RHEL** during FuSViz dependency setup, 
